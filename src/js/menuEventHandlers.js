...
document.querySelector('#split-beams-by-lyrics__submenu-item').addEventListener('click', () => menu.applyFilter('autobeam -l'));
document.querySelector('#tonic-to-c__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -k c', null, null, e.target.textContent.trim()));
document.querySelector('#tonic-to-c-sharp-__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -k c#', null, null, e.target.textContent.trim()));
document.querySelector('#tonic-to-d-flat-__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -k d-', null, null, e.target.textContent.trim()));
document.querySelector('#tonic-to-d__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -k d', null, null, e.target.textContent.trim()));
document.querySelector('#tonic-to-e-flat-__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -k e-', null, null, e.target.textContent.trim()));
document.querySelector('#tonic-to-e__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -k e', null, null, e.target.textContent.trim()));
document.querySelector('#tonic-to-f__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -k f', null, null, e.target.textContent.trim()));
document.querySelector('#tonic-to-f-sharp-__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -k f#', null, null, e.target.textContent.trim()));
document.querySelector('#tonic-to-g__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -k g', null, null, e.target.textContent.trim()));
document.querySelector('#tonic-to-a-flat-__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -k a-', null, null, e.target.textContent.trim()));
document.querySelector('#tonic-to-a__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -k a', null, null, e.target.textContent.trim()));
document.querySelector('#tonic-to-b-flat-__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -k b-', null, null, e.target.textContent.trim()));
document.querySelector('#tonic-to-b__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -k b', null, null, e.target.textContent.trim()));
document.querySelector('#up-a-minor-second__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t m2', null, null, e.target.textContent.trim()));
document.querySelector('#up-a-major-second__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t M2', null, null, e.target.textContent.trim()));
document.querySelector('#up-a-minor-third__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t m3', null, null, e.target.textContent.trim()));
document.querySelector('#up-a-major-third__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t M3', null, null, e.target.textContent.trim()));
document.querySelector('#up-a-perfect-fourth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t P4', null, null, e.target.textContent.trim()));
document.querySelector('#up-an-augmented-fourth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t A4', null, null, e.target.textContent.trim()));
document.querySelector('#up-a-diminished-fifth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t d5', null, null, e.target.textContent.trim()));
document.querySelector('#up-a-perfect-fifth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t P5', null, null, e.target.textContent.trim()));
document.querySelector('#up-a-minor-sixth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t m6', null, null, e.target.textContent.trim()));
document.querySelector('#up-a-major-sixth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t M6', null, null, e.target.textContent.trim()));
document.querySelector('#up-a-minor-seventh__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t m7', null, null, e.target.textContent.trim()));
document.querySelector('#up-a-major-seventh__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t M7', null, null, e.target.textContent.trim()));
document.querySelector('#up-a-perfect-octave__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t P8', null, null, e.target.textContent.trim()));
document.querySelector('#down-a-minor-second__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -m2', null, null, e.target.textContent.trim()));
document.querySelector('#down-a-major-second__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -M2', null, null, e.target.textContent.trim()));
document.querySelector('#down-a-minor-third__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -m3', null, null, e.target.textContent.trim()));
document.querySelector('#down-a-major-third__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -M3', null, null, e.target.textContent.trim()));
document.querySelector('#down-a-perfect-fourth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -P4', null, null, e.target.textContent.trim()));
document.querySelector('#down-an-augmented-fourth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -A4', null, null, e.target.textContent.trim()));
document.querySelector('#down-an-diminished-fifth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -d5', null, null, e.target.textContent.trim()));
document.querySelector('#down-a-perfect-fifth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -P5', null, null, e.target.textContent.trim()));
document.querySelector('#down-a-minor-sixth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -m6', null, null, e.target.textContent.trim()));
document.querySelector('#down-a-major-sixth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -M6', null, null, e.target.textContent.trim()));
document.querySelector('#down-a-minor-seventh__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -m7', null, null, e.target.textContent.trim()));
document.querySelector('#down-a-major-seventh__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -M7', null, null, e.target.textContent.trim()));
document.querySelector('#down-a-perfect-octave__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -P8', null, null, e.target.textContent.trim()));
