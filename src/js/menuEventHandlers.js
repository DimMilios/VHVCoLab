...
document.querySelector('#split-beams-by-lyrics__submenu-item').addEventListener('click', () => menu.applyFilter('autobeam -l'));
document.querySelector('#up-a-minor-second__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t m2', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#up-a-major-second__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t M2', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#up-a-minor-third__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t m3', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#up-a-major-third__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t M3', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#up-a-perfect-fourth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t P4', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#up-an-augmented-fourth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t A4', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#up-a-diminished-fifth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t d5', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#up-a-perfect-fifth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t P5', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#up-a-minor-sixth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t m6', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#up-a-major-sixth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t M6', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#up-a-minor-seventh__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t m7', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#up-a-major-seventh__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t M7', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#up-a-perfect-octave__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t P8', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#down-a-minor-second__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -m2', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#down-a-major-second__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -M2', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#down-a-minor-third__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -m3', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#down-a-major-third__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -M3', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#down-a-perfect-fourth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -P4', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#down-an-augmented-fourth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -A4', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#down-an-diminished-fifth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -d5', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#down-a-perfect-fifth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -P5', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#down-a-minor-sixth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -m6', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#down-a-major-sixth__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -M6', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#down-a-minor-seventh__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -m7', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#down-a-major-seventh__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -M7', null, null, e.currentTarget.querySelector('a').textContent.trim()));
document.querySelector('#down-a-perfect-octave__submenu-item').addEventListener('click', (e) => menu.applyFilter('transpose -t -P8', null, null, e.currentTarget.querySelector('a').textContent.trim()));
