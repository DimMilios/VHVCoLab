...
document
  .querySelector('#export-to-my-private-files__submenu-item')
  .addEventListener('click', () => menu.exportToPrivateFiles());
document
...
document
  .querySelector('#insert-interpretation-line--above-cursor-__submenu-item')
  .addEventListener('click', () => menu.insertInterpretationCommentLine());
document
...
document
  .querySelector('#unfocus-beam__submenu-item')
  .addEventListener('click', () => menu.unfocusElement());
document
...
document
  .querySelector('#unfocus-note__submenu-item')
  .addEventListener('click', () => menu.unfocusElement());
document
...
document
  .querySelector('#unfocus-rest__submenu-item')
  .addEventListener('click', () => menu.unfocusElement());
document
  .querySelector('#next-melodic-note__submenu-item')
  .addEventListener('click', () => menu.nextMelodicNote());
...
document
  .querySelector('#unfocus-slur__submenu-item')
  .addEventListener('click', () => menu.unfocusElement());
document
