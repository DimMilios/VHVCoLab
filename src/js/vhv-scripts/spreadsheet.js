...
function showSpreadsheetIconState() {
	...
	window.SPREADSHEETSCRIPTID = scriptid;
	window.SPREADSHEETID = sheetid;
...
function getSpreadsheetScriptId(value) {
	...
	window.SPREADSHEETSCRIPTID = value;
	localStorage.SPREADSHEETSCRIPTID = window.SPREADSHEETSCRIPTID;
	return value;
}
...
function getSpreadsheetId(value) {
	...
	if (matches) {
 	...
 	window.SPREADSHEETID = value;
	localStorage.SPREADSHEETID = window.SPREADSHEETID;
	return value;
}
...
function fillSpreadsheetId() {
	...
	if (window.SPREADSHEETSCRIPTID) {
		value = window.SPREADSHEETSCRIPTID;
	}
