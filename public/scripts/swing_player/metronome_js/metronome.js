class Metronome{
    ...
    constructor(audioManager){
        ...
        // audio clicks
        this.click = true;
        this.smallClick1 = new Audio('https://musicolab.hmu.gr/apprepository/vhvWs/scripts/swing_player')
        this.smallClick1.crossOrigin="anonymous";
        this.smallClick2 = new Audio('https://musicolab.hmu.gr/apprepository/vhvWs/scripts/swing_player')
        this.smallClick2.crossOrigin="anonymous";
        this.playSmall1 = true;
        this.bigClick = new Audio('https://musicolab.hmu.gr/apprepository/vhvWs/scripts/swing_player')
        ...
        this.timerWorker = new Worker('https://musicolab.hmu.gr/apprepository/vhvWs/scripts/swing_player');
